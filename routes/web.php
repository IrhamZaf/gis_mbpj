...
use App\Http\Controllers\gis\AdminUserController;
use App\Http\Controllers\gis\AuthController;
use App\Http\Controllers\gis\DashboardController;
use App\Http\Controllers\gis\EngineerController;
use App\Http\Controllers\gis\IncidentController;
use App\Http\Controllers\gis\MapController;
use App\Http\Controllers\gis\ReportController;
use App\Http\Controllers\gis\SurveyController;
...
Route::middleware('auth')->group(function () {
    Route::get('/', [DashboardController::class, 'index'])->name('gis.dashboard');

    Route::get('/api/dashboard/stats', [DashboardController::class, 'stats'])->name('api.dashboard.stats');
    Route::get('/api/incidents/geojson', [MapController::class, 'incidentsGeoJson'])->name('api.incidents.geojson');
    Route::get('/api/layers/{layer}/geojson', [MapController::class, 'layerGeoJson'])->name('api.layers.geojson');
    Route::get('/api/incidents/datatable', [IncidentController::class, 'dataTable'])->name('api.incidents.datatable');

    Route::get('/gis/map', [MapController::class, 'index'])->name('gis.map');
    Route::get('/gis/layers', [MapController::class, 'layers'])->name('gis.layers');

    Route::resource('incidents', IncidentController::class);
    Route::get('incidents/{incident}/survey-upload/{upload}/download', [IncidentController::class, 'downloadSurveyUpload'])->name('incidents.survey.download');
    Route::get('incidents/{incident}/survey-upload/{upload}/view', [IncidentController::class, 'viewSurveyUpload'])->name('incidents.survey.view');

    Route::middleware('role:admin,vendor')->group(function () {
        Route::get('/survey', [SurveyController::class, 'index'])->name('survey.index');
        Route::get('/survey/upload', [SurveyController::class, 'upload'])->name('survey.upload');
        Route::post('/survey/store', [SurveyController::class, 'store'])->name('survey.store');
    });

    Route::middleware('role:engineer,admin')->group(function () {
        Route::get('/engineer', [EngineerController::class, 'index'])->name('engineer.index');
        Route::get('/engineer/survey-files', [EngineerController::class, 'surveyFiles'])->name('engineer.survey.files');
        Route::get('/engineer/pending', [EngineerController::class, 'pending'])->name('engineer.pending');
        Route::get('/engineer/approved', [EngineerController::class, 'approved'])->name('engineer.approved');
        Route::get('/engineer/review/{incident}', [EngineerController::class, 'review'])->name('engineer.review');
        Route::post('/engineer/approve/{incident}', [EngineerController::class, 'approve'])->name('engineer.approve');
        Route::post('/engineer/reject/{incident}', [EngineerController::class, 'reject'])->name('engineer.reject');
        Route::get('/engineer/survey-upload/{upload}/download', [EngineerController::class, 'downloadSurveyUpload'])->name('engineer.survey.download');
        Route::get('/engineer/survey-upload/{upload}/view', [EngineerController::class, 'viewSurveyUpload'])->name('engineer.survey.view');
        Route::post('/engineer/survey/{survey}/approve', [EngineerController::class, 'approveSurvey'])->name('engineer.survey.approve');
        Route::post('/engineer/survey/{survey}/reject', [EngineerController::class, 'rejectSurvey'])->name('engineer.survey.reject');
        Route::post('/engineer/{incident}/request-additional-survey', [EngineerController::class, 'requestAdditionalSurvey'])->name('engineer.survey.request_additional');
    });
    ...
    Route::get('/reports/pdf/{incident}', [ReportController::class, 'generatePdf'])->name('reports.pdf');
...
// Main Page Route (template demos — requires login for GIS; keep demos accessible)
